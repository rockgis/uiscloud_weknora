// Package main is the main package for the uiscloud_weknora server
...
//
// @contact.name   uiscloud_weknora Github
// @contact.url    https://github.com/rockgis/uiscloud_weknora
//
// @host      localhost:8080
// @BasePath  /api/v1
//
