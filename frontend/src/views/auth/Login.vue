<template>
  <div class="login-layout">
    ...
    <!-- Logo - Top Left -->
    <a href="https://github.com/rockgis/uiscloud_weknora" target="_blank" class="header-logo" :title="$t('common.github')">
      <img src="@/assets/img/weknora.png" alt="uiscloud_weknora" class="logo-image" />
    </a>
    ...
    <div class="header-links">
      ...
      <a href="https://github.com/rockgis/uiscloud_weknora" target="_blank" class="header-link" :title="$t('common.info')">
...
const languageOptions = [
  { value: 'ko-KR', label: '한국어', shortLabel: 'KO', flag: '🇰🇷' },
