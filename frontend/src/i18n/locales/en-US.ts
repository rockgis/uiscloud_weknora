export default {
  ...
  initialization: {
    ...
    welcome: 'Welcome to uiscloud_weknora',
    ...
    separatorChineseSemicolon: 'Fullwidth semicolon (；)',
    separatorComma: 'Comma (,)',
    separatorChineseComma: 'Fullwidth comma (，)',
    ...
    sampleTextPlaceholder: 'Enter text for analysis, e.g.: "The Cloud Dream of the Nine" is one of the great classical novels of Korean literature, written by Kim Man-jung during the Joseon Dynasty...',
    generateRandomText: 'Generate Random Text',
  ...
  auth: {
    ...
    usernameInvalid: 'Username can only contain letters, numbers, underscores and Korean characters',
  ...
  knowledgeEditor: {
    ...
    faqImport: {
      ...
      fileTip: 'Supports JSON / CSV / Excel. CSV/Excel headers: category(required), question(required), similar_questions(optional-multiple with ##), negative_questions(optional-multiple with ##), answer(required-multiple with ##), reply_all(optional-default FALSE), disabled(optional-default FALSE), no_recommend(optional-default False). Also supports old format: standard_question, answers, similar_questions, negative_questions',
...
\
        ...
        semicolonCn: 'Fullwidth semicolon (；)',
