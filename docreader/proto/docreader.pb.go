...
const (
	...
	StorageProvider_COS                          StorageProvider = 1
	StorageProvider_MINIO                        StorageProvider = 2
)
...
type StorageConfig struct {
	...
	Provider        StorageProvider        `protobuf:"varint,1,opt,name=provider,proto3,enum=docreader.StorageProvider" json:"provider,omitempty"`
...
type ReadConfig struct {
	...
	EnableMultimodal bool                   `protobuf:"varint,4,opt,name=enable_multimodal,json=enableMultimodal,proto3" json:"enable_multimodal,omitempty"`
