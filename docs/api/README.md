...
uiscloud_weknora는 지식베이스 생성 및 관리, 지식 검색, 그리고 지식 기반 질의응답을 위한 일련의 RESTful API를 제공합니다. 본 문서에서는 이러한 API의 사용 방법을 상세히 설명합니다.
...
uiscloud_weknora API는 기능별로 다음과 같이 분류됩니다:
