...
// GetTenant godoc
// @Summary      테넌트 상세 조회
// @Description  ID로 테넌트 상세 정보를 조회합니다
// @Tags         테넌트 관리
// @Accept       json
// @Produce      json
...
// @Failure      400  {object}  errors.AppError         "잘못된 요청 파라미터"
// @Failure      404  {object}  errors.AppError         "테넌트가 존재하지 않습니다"
// @Security     Bearer
...
// @Description  시스템의 모든 테넌트를 조회합니다 (크로스 테넌트 접근 권한 필요)
// @Tags         테넌트 관리
// @Accept       json
// @Produce      json
...
// SearchTenants godoc
// @Summary      테넌트 검색
// @Description  테넌트 페이지네이션 검색（크로스 테넌트 접근 권한 필요）
// @Tags         테넌트 관리
// @Accept       json
// @Produce      json
...
// @Summary      테넌트 에이전트 설정 조회
// @Description  테넌트의 글로벌 에이전트 설정을 조회합니다 (기본적으로 모든 세션에 적용)
// @Tags         테넌트 관리
// @Accept       json
// @Produce      json
// @Success      200  {object}  map[string]interface{}  "에이전트 설정"
// @Failure      400  {object}  errors.AppError         "잘못된 요청 파라미터"
// @Security     Bearer
...
// @Description  테넌트 수준 KV 설정을 조회합니다 (agent-config, web-search-config, conversation-config 지원)
// @Tags         테넌트 관리
// @Accept       json
// @Produce      json
// @Param        key  path      string  true  "설정 키 이름"
...
// @Summary      테넌트 업데이트KV 설정
// @Description  테넌트 수준 KV 설정을 업데이트합니다 (agent-config, web-search-config, conversation-config 지원)
// @Tags         테넌트 관리
// @Accept       json
// @Produce      json
// @Param        key      path      string  true  "설정 키 이름"
...
// @Description  테넌트의 웹 검색 설정을 조회합니다
// @Tags         테넌트 관리
// @Accept       json
// @Produce      json
...
// @Description  테넌트의 글로벌 대화 설정을 조회합니다 (기본적으로 일반 모드 세션에 적용)
// @Tags         테넌트 관리
// @Accept       json
// @Produce      json
