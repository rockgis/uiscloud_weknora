...
// Evaluation godoc
// @Summary      평가 실행
// @Description  지식베이스에 대한 평가 테스트를 수행합니다
// @Tags         평가
// @Accept       json
// @Produce      json
// @Param        request  body      EvaluationRequest  true  "평가 요청 파라미터"
...
// @Summary      평가 결과 조회
// @Description  작업 ID로 평가 결과를 조회합니다
// @Tags         평가
// @Accept       json
// @Produce      json
// @Param        task_id  query     string  true  "평가 작업ID"
