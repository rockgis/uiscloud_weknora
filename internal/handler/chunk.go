...
// @Summary      ID로 청크 조회
// @Description  청크 ID만으로 청크 상세 정보를 조회합니다 (knowledge_id 불필요)
// @Tags         청크 관리
// @Accept       json
// @Produce      json
...
// @Failure      404  {object}  errors.AppError         "청크가 존재하지 않습니다"
// @Security     Bearer
...
// @Summary      지식 청크 목록 조회
// @Description  지정된 지식의 모든 청크 목록을 조회합니다，페이지네이션 지원
// @Tags         청크 관리
// @Accept       json
// @Produce      json
...
// UpdateChunk godoc
// @Summary      청크 업데이트
// @Description  지정된 청크의 내용과 속성을 업데이트합니다
// @Tags         청크 관리
// @Accept       json
// @Produce      json
// @Param        knowledge_id  path      string              true  "지식 ID"
...
// @Summary      지식 삭제 하의 모든 청크
// @Description  지정된 지식의 모든 청크를 삭제합니다
// @Tags         청크 관리
// @Accept       json
// @Produce      json
// @Param        knowledge_id  path      string  true  "지식 ID"
