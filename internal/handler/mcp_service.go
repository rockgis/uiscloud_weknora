...
// @Summary      MCP 서비스 생성
// @Description  새 MCP 서비스 설정을 생성합니다
// @Tags         MCP 서비스
// @Accept       json
// @Produce      json
// @Param        request  body      types.MCPService  true  "MCP 서비스 설정"
...
// @Description  현재 테넌트의 모든 MCP 서비스를 조회합니다
// @Tags         MCP 서비스
// @Accept       json
// @Produce      json
...
// @Description  MCP 서비스 설정을 업데이트합니다
// @Tags         MCP 서비스
// @Accept       json
// @Produce      json
// @Param        id       path      string  true  "MCP 서비스 ID"
// @Param        request  body      object  true  "업데이트 필드"
// @Success      200      {object}  map[string]interface{}  "업데이트된MCP 서비스"
// @Failure      400      {object}  errors.AppError         "잘못된 요청 파라미터"
// @Security     Bearer
...
// @Summary      MCP 테스트 서비스 연결
// @Description  MCP 서비스의 정상 연결 여부를 테스트합니다
// @Tags         MCP 서비스
// @Accept       json
// @Produce      json
// @Param        id   path      string  true  "MCP 서비스 ID"
...
// @Description  MCP 서비스가 제공하는 도구 목록을 조회합니다
// @Tags         MCP 서비스
// @Accept       json
// @Produce      json
// @Param        id   path      string  true  "MCP 서비스 ID"
...
// @Description  MCP 서비스가 제공하는 리소스 목록을 조회합니다
// @Tags         MCP 서비스
// @Accept       json
// @Produce      json
// @Param        id   path      string  true  "MCP 서비스 ID"
