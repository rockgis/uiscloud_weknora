...
// @Accept       json
// @Produce      json
// @Param        request  body      types.RegisterRequest  true  "등록 요청 파라미터"
...
// Login godoc
// @Summary      사용자 로그인
// @Description  사용자 로그인 및 액세스 토큰을 발급합니다
// @Tags         인증
// @Accept       json
// @Produce      json
// @Param        request  body      types.LoginRequest  true  "로그인 요청 파라미터"
// @Success      200      {object}  types.LoginResponse
// @Failure      401      {object}  errors.AppError  "인증실패"
...
// @Accept       json
// @Produce      json
// @Param        request  body      object{refreshToken=string}  true  "토큰 갱신"
...
// @Failure      401  {object}  errors.AppError         "권한 없음"
// @Security     Bearer
// @Router       /auth/me [get]
...
// @Summary      변경비밀번호
// @Description  현재사용자의 로그인비밀번호
// @Tags         인증
// @Accept       json
// @Produce      json
// @Param        request  body      object{old_password=string,new_password=string}  true  "비밀번호변경 요청"
