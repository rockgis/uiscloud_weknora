...
// Common Korean and English stopwords
var stopwords = map[string]struct{}{
	// Korean particles and functional words
	"이": {}, "가": {}, "을": {}, "를": {}, "은": {}, "는": {},
	"의": {}, "에": {}, "에서": {}, "로": {}, "으로": {},
	"과": {}, "와": {}, "도": {}, "만": {},
	"이다": {}, "있다": {}, "하다": {},
...
// Korean question word prefixes
var questionWords = regexp.MustCompile(`^(무엇인가요|무엇인지|무엇이|무엇을|무엇|어떻게|어떤|왜|언제|어디서|어디|어느|누가|누구를|누구|알려줘|알려주세요|설명해줘|설명해주세요|알고\s*싶어요|알고\s*싶어|뭐야|뭐가|뭐를|뭐인가|뭐|도와줘|도와주세요)\s*`)
...
func tokenize(text string) []string {
	...
	for _, r := range text {
		if unicode.IsLetter(r) || unicode.IsDigit(r) {
			// Accumulate letters and digits (covers Korean Hangul, Latin, etc.)
			current.WriteRune(r)
		} else {
			// Delimiter: flush accumulated token
			if current.Len() > 0 {
