...
import (
	...
	elasticsearchRepoV7 "github.com/Tencent/uiscloud_weknora/internal/application/repository/retriever/elasticsearch/v7"
	elasticsearchRepoV8 "github.com/Tencent/uiscloud_weknora/internal/application/repository/retriever/elasticsearch/v8"
	neo4jRepo "github.com/Tencent/uiscloud_weknora/internal/application/repository/retriever/neo4j"
	postgresRepo "github.com/Tencent/uiscloud_weknora/internal/application/repository/retriever/postgres"
	qdrantRepo "github.com/Tencent/uiscloud_weknora/internal/application/repository/retriever/qdrant"
...
// Logs fatal error and exits if the error is not nil
// Used for configuration steps that must succeed during container initialization
// Parameters:
//   - err: Error to check
func must(err error) {
	if err != nil {
